...
Capistrano::Configuration.instance.load do
  ...
  namespace :deploy do
    ...
    namespace :mongoid do
      ...
      desc <<-DESC
        [internal] Removes the mongoid.yml file after code_update in order for the symlink to work
      DESC
      task :remove_config, :except => { :no_release => true } do
        f = "#{release_path}/config/mongoid.yml"
    ...
    after "deploy:code_update",     "deploy:mongoid:remove_config"
    after "deploy:finalize_update", "deploy:mongoid:symlink"
